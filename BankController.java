...
public class BankController
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            table.add(new User(12347887,"Usha", 1234, 500000));
            table.add(new User( 23429876,  "Nethra",  1111,  506700));
            table.add(new User( 12780009,  "Nisha",  2231,  370000));
            table.add(new User( 87667655,  "Anusha", 4645,  750800));
            table.add(new User( 78644323,  "Amith", 3333,  736700));
            table.add(new User( 76450987, "Nisarga", 5467,  249700));
            table.add(new User( 44447655,  "Shravani",  4567,  367000));
            table.add(new User( 55550876,  "Ammu",  1124,  30000));
            table.add(new User( 12565434,  "Ram",  1677, 2
                    9000));
            ...
            while(true)
            {
                ...
                System.out.println("For new user>>ress 1 -open new account");
